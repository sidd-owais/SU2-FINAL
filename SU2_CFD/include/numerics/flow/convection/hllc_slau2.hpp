...
public:
   ...
   */
  CUpwHLLC_PLUS_SLAU2_Flow(unsigned short val_nDim, unsigned short val_nVar, const CConfig* config);

  /*!
   * \brief Destructor of the class.
   */
  ~CUpwHLLC_PLUS_SLAU2_Flow(void) override;
  ...
  void ComputeMassAndPressureFluxes(const CConfig* config, su2double &mdot, su2double &pressure);
};
